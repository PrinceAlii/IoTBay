...
CREATE TABLE `User` (
  ...
  `userContactNumber` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1234567922 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
