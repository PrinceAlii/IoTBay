...
<html>
    ...
    <body class="text-center">
        ...
        <div class="container">
            <h1 class="mt-5 mb-3">Delete Product</h1>
            ...
            <form action="DeleteProductServlet" method="post" class="row g-3">
                <div class="container d-flex h-100 align-items-center justify-content-center">
                    <div class="text-center">
                        ...
                        <div class="mt-4"><button type="submit" class="btn btn-danger">Delete Product</button></div>
                    </div>
                </div>
