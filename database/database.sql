...
INSERT INTO IOTBAY.PaymentDetails (paymentMethod,paymentCardDetails,savedPaymentDetails,userID) VALUES
    ...
    ('Visa','1552',1,3),
    ('MasterCard','8533',1,4),
    ('AmericanExpress','3786',1,5),
    ('Visa','1212',1,6),
    ('MasterCard','4947',1,7),
    ('Visa','0507',1,8),
    ('Visa','9065',1,9),
    ('Visa','5763',1,10),
    ('MasterCard','6104',1,11),
    ('AmericanExpress','7906',1,12),
    ('Visa','2486',1,13),
    ('MasterCard','4525',1,14),
    ('MasterCard','5394',1,15),
    ('MasterCard','4721',1,16),
    ('Visa','0550',1,17),
    ('Visa','4635',1,18),
    ('AmericanExpress','2201',1,19),
    ('AmericanExpress','5558',1,20),
    ('MasterCard','1588',1,21),
    ('Visa','8797',1,22),
    ('Visa','2891',1,1),
    ('MasterCard','7419',1,2),
    ('AmericanExpress','6023',1,3),
    ('Visa','3150',1,4),
    ('MasterCard','0987',1,5),
    ('Visa','5246',1,6),
    ('MasterCard','9632',1,7),
    ('Visa','1470',1,8),
    ('AmericanExpress','8514',1,9),
    ('Visa','7325',1,10),
    ('MasterCard','4061',1,11),
    ('AmericanExpress','2190',1,12),
    ('Visa','6837',1,13),
    ('MasterCard','3904',1,14),
    ('MasterCard','5078',1,15),
    ('MasterCard','2613',1,16),
    ('Visa','8452',1,17),
    ('Visa','0139',1,18),
    ('AmericanExpress','9761',1,19),
    ('AmericanExpress','4358',1,20),
    ('MasterCard','1285',1,21),
    ('Visa','6902',1,22);
